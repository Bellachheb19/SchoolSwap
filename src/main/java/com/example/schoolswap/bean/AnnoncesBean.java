    ...
    public String sauvegarder() {
        try {
            ...
            if (uploadedFile != null && uploadedFile.getSize() > 0) {
                ...
                // === 1. Chemin physique fixe pour les uploads sur Windows ===
                String uploadDir = "C:\\Users\\mvpro\\Desktop\\salma\\Ginf2\\Jakarta EE\\SchoolSwap\\src\\main\\webapp\\uploads";
                File dir = new File(uploadDir);
                if (!dir.exists()) {
                    dir.mkdirs();
                }

                // === 2. Génération d'un nom unique pour l'image ===
                String fileName = System.currentTimeMillis() + "_" + uploadedFile.getSubmittedFileName();
                ...
                // === 4. Chemin relatif en base pour affichage dans le front ===
                articleCourant.setPhoto("uploads/" + fileName); // utilisé dans <h:graphicImage>
            }
            ...
            if (modeEdition) {
                ...
                aBase.setIdCat(cat);
                // Mettre à jour image seulement si nouvelle image choisie
                if (articleCourant.getPhoto() != null) {
                    aBase.setPhoto(articleCourant.getPhoto());
                }
